...
(setq doom-ayu-mirage-brighter-modeline t)
...
(after! lsp-clients
  (lsp-register-client
   (make-lsp-client :new-connection (lsp-stdio-connection (list
                                                           "vtsls"
                                                           "--stdio"))
                    :major-modes '(jtsx-tsx-mode typescript-mode rjsx-mode js-mode)
                    :server-id 'vtsls
                    :priority -1)))

(setq! +lsp-company-backends '(:separate company-capf company-dabbrev company-files))
